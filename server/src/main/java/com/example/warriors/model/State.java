...
public class State {
    ...
    public State(StateID state, DistrictEnsemble districtsYR22, DistrictEnsemble districtsRandom1,
            DistrictEnsemble districtsRandom2, DistrictEnsemble districtsRandom3, Ensemble ensemble) {
        this.state = state;
    ...
    public boolean equals(Object o) {
        ...
        State state = (State) o;
        return Objects.equals(state, state.state) && Objects.equals(districtsYR22, state.districtsYR22)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(state, districtsYR22, districtsRandom1, districtsRandom2, districtsRandom3, ensemble);
    }
