...
import { MapContainer, TileLayer, Marker, Popup, GeoJSON, useMap, Polyline } from "react-leaflet";
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={6} md={6}>
          ...
          >
            ...
            <Polyline pathOptions={colorDistrict} positions={pa2020.features[0].geometry.coordinates[0]} />
            {filter.twoZero && <GeoJSON data={pa2020.features} style={colorDistrict} />}
